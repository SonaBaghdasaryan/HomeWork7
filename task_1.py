...
#
#
# def rename_files(directory: Path, name_for_files: str, amount_digit: int, old_file_extension: str,
...
#     rename_files(Path('files'), name_for_files='_test_', amount_digit=3, old_file_extension='bin',
